...
public:
   TinyGPSCustom() {};
   TinyGPSCustom(TinyGPS &gps, const char *sentenceName, int termNumber);
   void begin(TinyGPS &gps, const char *_sentenceName, int _termNumber);
